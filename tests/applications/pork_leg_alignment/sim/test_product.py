...
def test_the_collision_shape_follows_the_shank_instead_of_bridging_the_waist(leg_cell) -> None:
    ...
    """
    from applications.pork_leg_alignment.sim.product import HAM_GEOMS, HAM_SECTION_FRACTIONS, leg_half_width_m
...
def test_a_trotter_hanging_past_the_belt_edge_stays_in_line_with_the_ham() -> None:
    ...
    """
    from applications.pork_leg_alignment.sim.product import leg_centreline
