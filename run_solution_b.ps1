...
try {
    & $isaacPython isaac_sim\run_scene2_integrated.py --solution b --seed $Seed --scenario $Scenario --belt-speed-mps $BeltSpeedMps --start-y-m $StartYM --start-yaw-deg $StartYawDeg --output-root $OutputRoot --fps 12
