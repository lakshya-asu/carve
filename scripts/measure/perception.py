...
time. Every number the perception and tracking notes quote comes from here.
    ...
    env -u PYTHONPATH PYTHONPATH=src MUJOCO_GL=egl \
        python scripts/measure/perception.py --episodes 40
...
from robotics.core.frames import pixel_to_plane, world_to_base, world_to_pixel
from robotics.perception.pose_estimation import PerceptionRejectedError, estimate_from_depth, estimate_from_mask
