...
6 mm at the 95th percentile with no source. This measures it.
    ...
    env -u PYTHONPATH PYTHONPATH=src MUJOCO_GL=egl \
        python scripts/measure/grasp_shift.py --trials 12
...
from applications.pork_leg_alignment.sim.scene import CellConfig, SlabConfig, build_model
from robotics.core.contracts import wrap_axis_angle
from robotics.hardware.ik import UnreachableError, arm_qpos_indices, solve_ik, tool_pose
