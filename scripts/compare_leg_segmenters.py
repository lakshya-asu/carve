...
`scripts/measure_leg_segmentation.py`, run through
...
with each method's time per frame on this CPU.
    ...
    env -u PYTHONPATH PYTHONPATH=src MUJOCO_GL=egl \
        python scripts/compare_leg_segmenters.py --checkpoint outputs/checkpoints/<file>.pt
...
from meat_cell_sim.learned_segmentation import LearnedLegSegmenter
...
from meat_cell_sim.segmentation import largest_component, score_mask
