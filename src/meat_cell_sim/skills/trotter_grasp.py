...
from meat_cell_sim.arm import UnreachableError, solve_ik_rotation, tool_pose, tool_rotation_for_approach
from meat_cell_sim.cell import Cell
from meat_cell_sim.product import PRODUCT_BODY, leg_centreline, leg_half_width_m
from meat_cell_sim.saw import BELT_BODY, BELT_GEOM
from meat_cell_sim.skills.grasp import (
    CLOSE_S,
    LIFT_CHECK_M,
    LIFT_NOT_ACHIEVED,
    LIFT_TOOL_MIN_M,
